...
run "mkdir tmp_stylesheets && unzip stylesheets.zip -d tmp_stylesheets && mv tmp_stylesheets/rails-stylesheets-more-js app/assets/stylesheets && rm -rf tmp_stylesheets && rm -f stylesheets.zip"
